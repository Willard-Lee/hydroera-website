...
export interface Footer {
  id: number;
  /**
   * Footer brand logo (light version recommended for dark background)
   */
  logo?: (number | null) | Media;
  /**
   * Brief company description shown below the logo
   */
  description?: string | null;
  columns?:
    | {
        /**
         * Column heading (e.g. "Company", "Services")
         */
        title: string;
        links?:
          | {
  ...
  contact?: {
    /**
     * Phone number (e.g. +60 12-345 6789)
     */
    phone?: string | null;
    email?: string | null;
    address?: string | null;
  ...
  socialLinks?:
    ...
    | null;
  /**
   * Copyright text shown in the bottom bar
   */
